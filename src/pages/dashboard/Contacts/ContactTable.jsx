      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="text-[var(--color-text-body)] border-b border-[var(--color-border)]">
            ...
            <th className="py-4 font-semibold text-center hidden md:table-cell">
              E-mail
            </th>
            <th className="py-4 font-semibold text-center hidden lg:table-cell">
              Phone
            </th>
            <th className="py-4 font-semibold text-center hidden xl:table-cell">
              Job Title
            </th>
            <th className="py-4 font-semibold text-center hidden sm:table-cell">
              Date
            </th>
            ...
            contacts.map((contact, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-4 text-center hidden md:table-cell font-medium text-(--color-text-title)">
                    {contact.email}
                  </td>
                  <td className="py-4 text-center hidden lg:table-cell font-medium text-(--color-text-title)">
                    {contact.phone || "-"}
                  </td>
                  <td className="py-4 text-center hidden xl:table-cell font-medium text-(--color-text-title)">
                    {contact.jobTitle || "-"}
                  </td>
